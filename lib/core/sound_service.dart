...
///
/// Note: a persistent, pre-loaded-player version of this was tried and
/// reverted — on Flutter web, touching player state (setReleaseMode) at
/// construction time and calling seek/resume on a never-played player
/// triggered `MissingPluginException` on audioplayers' internal
/// "global/events" channel. This simple pattern is the one that's
/// actually been confirmed to produce sound.
class SoundService {
