...
///
/// The nickname and the bar are both pinned to the screen's middle third
/// via [Positioned], centered above the bar — independent of [leading]
/// (e.g. an opponent's live mini board) and [trailing] (e.g. the
/// picture-mode reference thumbnail), which sit at the row's edges. That's
/// what keeps "my" bar and the opponent's bar (and their labels) lined up
/// at the same x position even though only the opponent's row has a mini
/// board next to it.
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          if (leading != null)
            Positioned(left: 0, top: 0, bottom: 0, child: Center(child: leading)),
          Positioned(
            left: barLeft,
            width: barWidth,
            top: 0,
